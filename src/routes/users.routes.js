...
import { getUser, getUsers, createUser, updateUser, deleteUser, getUserRoutines, getUserRoutine } from "../controllers/users.controller.js";
...
const router = Router();
router.get("/:id/routines/:routineId", validateId, getUserRoutine);
